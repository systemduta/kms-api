...
class CreatePasPenilaianOthersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pas_penilaian_others', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pas_penilaian_others');
    }
}
